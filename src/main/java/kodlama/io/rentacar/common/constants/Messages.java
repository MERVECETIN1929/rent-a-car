...
public class Messages {
    ...
    public static class Rental {
        public static final String NotExists = "RENTAL_NOT_EXİSTS";
        public static final String CarNotAvailable = "CAR_NOT_AVAILABLE";
    }

    public static class Payment {
        public static final String NotFound = "PAYMENT_NOT_FOUND";
        public static final String CardNumberAlreadyExists = "CARD_NUMBER_ALREADY_EXİSTS";
        public static final String NotEnoughMoney = "NOT_ENOUGH_MONEY";
        public static final String NotAValıdPayment = "NOT_A_VALID_PAYMENT";
    ...
    public static class Invoice {
        public static final String NotFound = "INVOICE_NOT_EXISTS";
    }
